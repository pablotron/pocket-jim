...
#define GET_WORD_OFFSET(word_id) ((uint16_t) pgm_read_word(WORDS + 2 * (word_id) + 0))
#define GET_WORD_LENGTH(word_id) ((uint16_t) pgm_read_word(WORDS + 2 * (word_id) + 1))
#else /* !__AVR_ARCH__ */
#include <string.h> // memcpy()
#define PROGMEM
#define memcpy_P memcpy
#define GET_WORD_OFFSET(word_id) WORDS[2 * (word_id) + 0]
#define GET_WORD_LENGTH(word_id) WORDS[2 * (word_id) + 1]
#endif /* __AVR_ARCH__ */
